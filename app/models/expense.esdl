module expense {
    abstract type Base {
        ...
        required property user_id -> uuid;
    ...
    type ExpenseCategory extending Base, ExpenseProperty {
    ...
    type ExpensePlace extending Base, ExpenseProperty {
    };
}
